...
begin
  ...
  if (lCampos[0].Caption = lCampos[1].Caption) AND (lCampos[0].Font.Color <> clBtnFace) AND (lCampos[1].Font.Color <> clBtnFace) AND (lCampos[1].Caption = lCampos[2].Caption) then
    begin
      MarcarPonto(1, FPonto1, FPonto2);
    end
  else if (lCampos[0].Caption = lCampos[3].Caption) AND (lCampos[0].Font.Color <> clBtnFace) AND (lCampos[3].Caption = lCampos[6].Caption) AND (lCampos[3].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(1, FPonto1, FPonto2);
    end
  else if (lCampos[0].Caption = lCampos[4].Caption) AND (lCampos[0].Font.Color <> clBtnFace) AND (lCampos[4].Caption = lCampos[8].Caption) AND (lCampos[4].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(1, FPonto1, FPonto2);
    end
  else if (lCampos[1].Caption = lCampos[4].Caption) AND (lCampos[1].Font.Color <> clBtnFace) AND (lCampos[4].Caption = lCampos[7].Caption) AND (lCampos[4].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(2, FPonto1, FPonto2);
    end
  else if (lCampos[2].Caption = lCampos[5].Caption) AND (lCampos[2].Font.Color <> clBtnFace) AND (lCampos[5].Caption = lCampos[8].Caption) AND (lCampos[5].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(3, FPonto1, FPonto2);
    end
  else if (lCampos[3].Caption = lCampos[4].Caption) AND (lCampos[3].Font.Color <> clBtnFace) AND (lCampos[4].Caption = lCampos[5].Caption) AND (lCampos[4].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(4, FPonto1, FPonto2);
    end
  else if (lCampos[6].Caption = lCampos[7].Caption) AND (lCampos[6].Font.Color <> clBtnFace) AND (lCampos[7].Caption = lCampos[8].Caption) AND (lCampos[7].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(7, FPonto1, FPonto2);
    end
  else if (lCampos[2].Caption = lCampos[4].Caption) AND (lCampos[2].Font.Color <> clBtnFace) AND (lCampos[4].Caption = lCampos[6].Caption) AND (lCampos[4].Font.Color <> clBtnFace) then
    begin
      MarcarPonto(3, FPonto1, FPonto2);
    end
  else if lQuantidade = 9 then
    begin
...
begin
  ...
  for lContador := 0 to 8 do
      if lCampos[lContador].Font.Color <> clBtnFace then lQuantidade := lQuantidade+1;
